                    ...
                    <div class="panel panel-default">
                        ...
                        <input type='hidden' name='amount' value='<c:out value="${cr.amount}"/>'>
	                        ...
	                        <div class="form-group">
		                        ...
		                        value='<fmt:formatDate pattern = "yyyy/MM/dd" value = "${board.regdate}"/>' readonly="readonly" type="hidden">
	                        </div>
	                        <div class="form-group">
		                        <!-- <label>Update Date</label> -->
		                        <input class="form-control" name="updateDate"
		                        value='<fmt:formatDate pattern = "yyyy/MM/dd" value = "${board.updateDate}"/>' readonly="readonly" type="hidden">
	                        </div>
